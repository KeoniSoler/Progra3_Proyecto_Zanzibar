        ...
        return(
            <section className = "sectionDetalle">
                ...
                <article className = "infoDetalle">
                    ...
                    <p className = "parrafoInfo">Rating: {this.state.data.vote_average}</p>
                    <p className = "parrafoInfo">Fecha de estreno: {this.state.data.release_date}</p>
                    <p className = "parrafoInfo">Duracion: {this.state.data.runtime}</p>
                    <p className = "parrafoInfo">Sinopsis: {this.state.data.overview}</p>
                    <p className = "parrafoInfo">Géneros: {this.state.data.genres ? this.state.data.genres.map((genero) => genero.name).join(', ') : 'Cargando géneros...'}</p>                    {
